        ...
        <section>
            <div class="wrapper">
                <div class="sub-wrapper">
                    ...
                    <h1 class="main-title">Kerangka Berpikir</h1>
                            ...
                            <div class="child-iidbc-blackforest">
                                <div class="group">
                                    ...
                                    <div class="content-idbc">
                                        <p>
                                            Dimensi yang dipahami dari program ini adalah studi sebagai alternatif kuliah dan bekerja
                                        </p>
                                    </div>
                                </div>
                                <div class="group">
                                    ...
                                    <div class="content-idbc">
                                        <p>
                                            Program ini mampu mengakselerasi belajar dan bekerja di negara maju.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="gambar">
                                <img src="../img/kerangka.jpg" alt="">
                            </div>
                            <div class="child-iidbc-blackforest">
                                <div class="group">
                                    <div class="icon-title">
                                    ...
                                    <div class="content-idbc">
                                        <p>
                                            Berkesempatan menampilkan sosok individu muslim yang baik di kancah dunia
                                        </p>
                                    </div>
                                </div>
                                <div class="group">
                                    ...
                                    <div class="content-idbc">
                                        <p>
                                            Mengoptimalkan kemajuan teknologi untuk mencapai ketakwaan sehingga perlu membuat wadah baru dengan mengoptimalisasi program di atas
                                        </p>
                                    </div>
                                </div>
                            </div>
