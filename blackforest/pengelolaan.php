        ...
        <section>
            <div class="wrapper">
                <div class="sub-wrapper">
                    <h1 class="main-title">pengelolaan Program</h1>
                    <div class="syarat-container-2">
                        <div class="timeline-syarat-2"></div>
                        <div class="timeline-syarat2-2"></div>
                        ...
                        <div class="card-group-2">
                            ...
                            <div class="card-right-2">
                                ...
                                <div class="card-content-2">
                                    <h1>harian</h1>
                                    <p>
                                        a. Mentoring, doa, dzikir. <br>
                                        b. Tilawah quran dan kajian.
                                    </p>
                                </div>
                            ...
                            <div class="card-left-2">
                                ...
                                <div class="card-content-2">
                                    <h1>mingguan</h1>
                                    <p>
                                        a. pengelolaan aktifitas liburan bersama. <br>
                                        b. Stadium general. <br>
                                        c. Gabungan kelompok (pertandingan & perlombaan). <br>
                                        d. Silaturrahmi bersama antar komunitas.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card-right-2">
                                ...
                                <div class="card-content-2">
                                    <h1>bulanan</h1>
                                    <p>
                                        a. Program bermalam bersama <br>
                                        b.  Kajian global via zoom bersama seluruh pembina, pengurus, peserta program di jerman dan seluruh orang tua di Indonesia.
                                    </p>
                                </div>
