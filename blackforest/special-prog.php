                ...
                <div class="sub-wrapper">
                    ...
                    <div class="container-iidbc-blackforest">
                        <div class="container-iidbc-blackforest">
                            <div class="child-iidbc-blackforest">
                                <div class="group">
                                    ...
                                    <div class="content-idbc">
                                        <p>
                                            Kaderisasi SDM
                                            <br> berwawasan Global <br>
                                            dan bervisi Peradaban
                                        </p>
                                    </div>
                                </div>
                                <div class="group">
                            ...
                            <div class="gambar">
                                <img src="../img/Logo-IDBC-Intenational-Jerman.png" alt="">
                            </div>
                            <div class="child-iidbc-blackforest">
                                <div class="group">
                                    <div class="icon-title">
                                    ...
                                    <div class="content-idbc">
                                        <p>
                                            Pendampingan pengembangan diri dan pemilihan bidang keilmuan sesuai dengan potensi
                                        </p>
                                    </div>
                                </div>
                                <div class="group">
