...
<head>
    ...
    <title>blackforest-menu</title>
    <link rel="icon" href="../img/3.png">


    <!-- link css -->
    <link rel="stylesheet" href="../style/styleblackforest.css">

    <!-- link font awesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css ">

    <!-- link java script -->
    <script defer src="../script/scriptblack-forest.js"></script>
</head>
            ...
            <div class="header-1">
                ...
                <nav class="navbar">
                    <ul>
                        ...
                        <li class="dropdown">
                            <p class="btn-drpdwn" id="current-page">BLACKFOREST <i class="fa-solid fa-caret-down"></i></p>
                            <div class="dropdown-menu">
                                <div class="box-title">
                                    <h1>BLACKFOREST</h1>
        ...
        <section>
            <div class="wrapper">
                <div class="sub-wrapper">
                    ...
                    <h1 class="main-title">keunggulan lembaga</h1>
                    <p class="second-title">Black Forest</p>


                    <div class="container-iidbc-blackforest-2">
                        <div class="child-iidbc-blackforest-2">
                            <div class="group">
                                <div class="icon-title">
                                    <div class="fa-solid fa-heading"></div>
                                    <h1>Pembina dan pengurus</h1>
                                </div>
                                <div class="content-idbc">
                                    <p>
                                        adalah diaspora dengan beragam profesi yang memiliki komitmen tinggi terhadap pengembangan SDM melalui pendidikan
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="group">
                                ...
                                <div class="content-idbc">
                                    <p>
                                        adalah para peneliti pendidikan yang telah berpengalaman luas dan telah melakukan penelitian hingga 60 negara
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="group">
                                <div class="icon-title">
                                    <div class="fa-solid fa-car"></div>
                                    <h1>Fasilitas</h1>
                                </div>
                                <div class="content-idbc">
                                    <p>
                                        lengkap dan modern untuk mendukung kegiatan pendidikan dan pelatihan
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="child-iidbc-blackforest-2">
                            <div class="group">
                                <div class="icon-title">
                                    ...
                                    <h1>Tenaga pengajar dan musyrif</h1>
                                </div>
                                <div class="content-idbc">
                                    <p>
                                        hafidz Quran dan telah berpengalaman membina banyak rumah Quran
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="child-iidbc-blackforest-2">
                            <div class="group">
                                <div class="icon-title">
                                    <div class="fa-brands fa-canadian-maple-leaf"></div>
                                    <h1>Metode pembelajaran</h1>
                                </div>
                                <div class="content-idbc">
                                    <p>
                                        praktis dan interaktif yang dapat membantu peserta memahami konsep dan aplikasinya dalam dunia kerja
                                    </p>
                                </div>
                            </div>
                            <div class="group">
                                ...
                                <div class="content-idbc">
                                    <p>
                                        Sertifikat yang diakui dan berharga di dunia kerja
                                    </p>
                                </div>
                            </div>
                            <div class="group">
                                ...
                                <div class="content-idbc">
                                    <p>
                                        disesuaikan dengan kebutuhan dan tingkat kemampuan peserta
                                    </p>
                                </div>
                            </div>
