        ...
        <section>
            <div class="wrapper">
                <div class="sub-wrapper">
                    ...
                    <h1 class="main-title">Keunggulan</h1>
                    <p class="second-title">Black Forest</p>

                    <div class="container-keunggulan">
                        <div class="child-keunggulan">
                            <div class="gambar-keunggulan">
                                <img src="../img/strategis.jpg" alt="">
                            </div>
                            <div class="content-keunggulan">
                                <p>Lokasi strategis area Black Forest, wilayah hutan lindung dan pariwisata di Jerman</p>
                            </div>
                        </div>
                        <div class="child-keunggulan">
                            <div class="gambar-keunggulan">
                                <img src="../img/praktik.jpg" alt="">
                            </div>
                            <div class="content-keunggulan">
                                <p>Metode : Aplikasi / praktek dan teori</p>
                            </div>
                        </div>
                        <div class="child-keunggulan">
                            <div class="gambar-keunggulan">
                                <img src="../img/efisiensi.jpg" alt="">
                            </div>
                            <div class="content-keunggulan">
                                <p>Waktu : Setiap musim / masa</p><br>
                                <p>Biaya : Terjangkau dan ter-cover program</p>
                            </div>
                        </div>
                    </div>
                </div>
