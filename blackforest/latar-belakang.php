                ...
                <div class="sub-wrapper">
                    <div class="container-about">
                        ...
                        <div class="child-about">
                            <div class="image-box">
                                <img src="../img/blackfores-1060x706.jpg">
                            </div>
                            <div class="box-year">
                                <p >Usia peserta secara umum masih dalam masa transisi dan perlu pendampingan.</p>
                                <br>
                                <p>Berada di negara maju dan non Muslim dengan segala kondisi IPOLEKSOSBUD HANKAMnya.</p>
                            </div>
                        </div>
                        ...
                        <div class="child-about">
                            ...
                            <div class="about-paragraf">
                                <p class="paragraf-1">
                                    Pengalaman panjang membawa putra putri bangsa Indonesia kuliah di luar negeri,
                                    tidak sedikit dari mereka hilang orientasinya hingga rusaknya moral karena salah teman
                                    dan salah lingkungan gaul.
                                    <br>
                                    <br>
                                </p>

                                <p class="paragraf-2">
                                    Perlunya pendampingan dan pengawalan dari yang lebih senior kepada junior untuk bisa
                                ...
                                <p class="paragraf-2">
                                    Kepentingan dakwah dengan keteladan di lokasi tinggal dan hal ini diperlukan pembinaan intensif
