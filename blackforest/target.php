        ...
        <section>
            <div class="wrapper">
                <div class="sub-wrapper">
                    <h1 class="main-title">Target Kompetensi Peserta</h1>
                    <div class="syarat-container-3">
                        <div class="timeline-syarat-diff"></div>
                        ...
                        <div class="card-group-3">
                            ...
                            <div class="card-right-3">
                                ...
                                <div class="card-content-3">
                                    <p>
                                        Memiliki pemahaman keagamaan yang komprehensif
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card-left-3">
                                ...
                                <div class="card-content-3">
                                    <p>
                                        Memiliki adab Islam yang tinggi
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card-right-3">
                                ...
                                <div class="card-content-3">
                                    <p>
                                        Memiliki mentalitas tangguh, mandiri dan disiplin
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card-left-3">
                                ...
                                <div class="card-content-3">
                                    <p>
                                        Menguasai ilmu pengetahuan luas berlandaskan IMTAQ (Iman dan Taqwa)
                                    </p>
                                </div>
                            </div>
                            <div class="card-right-3">
                                ...
                                <div class="card-content-3">
                                    <p>
                                        Memiliki skill tersertifikasi Internasional dan Networking Global
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="card-left-3">
                                ...
                                <div class="card-content-3">
                                    <p>
                                        Memiliki spirit tinggi menjadi agent of changes untuk peradaban Islam
                                    </p>
                                </div>
                            </div>
