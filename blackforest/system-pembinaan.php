        ...
        <section>
            <div class="wrapper">
                <div class="sub-wrapper">
                    ...
                    <h1 class="main-title">Spesial Program</h1>
                    ...
                    <div class="container-iidbc-blackforest">
                        <div class="container-iidbc-blackforest">
                            <div class="child-iidbc-blackforest">
                                <div class="group">
                                    <div class="icon-title">
                                        ...
                                        <h1>pengelolaan Program</h1>
                                    </div>
                                    <div class="content-idbc">
                                        <p>

                                            Aktivitas reguler 24 jam.
                                            <br>
                                            Kegiatan pembinaan 2 jam/hari dengan 2 hari/pekan (pagi atau malam).
                                            <br>
                                            1 kali program bersama setiap hari Sabtu.
                                            <br>
                                            Aktivitas bersama setiap pekan.
                                            <br>
                                            Mabit per 3 bulan.
                                            <br>
                                            Liburan bersama 2 kali/tahun.
                                        </p>
                                    </div>
                                </div>
                                <div class="group">
                            ...
                            <div class="gambar">
                                <img src="../img/logo BF.png" alt="">
                            </div>
                            <div class="child-iidbc-blackforest">
                                <div class="group">
                                    <div class="icon-title">
                                        <div class="fa-solid fa-paper-plane"></div>
                                        <h1>Tata Kelola SDM</h1>
                                    </div>
                                    <div class="content-idbc">
                                        <p>
                                            Musyrif
