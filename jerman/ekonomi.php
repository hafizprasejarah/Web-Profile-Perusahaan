...
<head>
    ...
    <title>jerman-menu</title>
    <link rel="icon" href="../img/3.png">

    <!-- link css -->
    <link rel="stylesheet" href="../style/jerman.css">
            ...
            <div class="header-1">
                ...
                <nav class="navbar">
                    <ul>
                        ...
                        <li class="dropdown">
                            <p class="btn-drpdwn" id="current-page">JERMAN <i class="fa-solid fa-caret-down"></i></p>
                            <div class="dropdown-menu">
                                <div class="box-title">
                                    <h1>kenapajerman?</h1>
                                    <a href="../jerman.php">
        ...
        <section>
            <div class="wrapper">
                <div class="sub-wrapper">
                    ...
                    <h1 class="main-title">Ekonomi</h1>
                    <p class="second-title">Mengenal Ekonomi Negara Jerman</p>

                    <div class="container-ekonomi">
                        <div class="child-ekonomi">

                            <div class="content-ekonomi">
                                <p>Jerman adalah negara pendiri Masyarakat Ekonomi
                                    Eropa yang kemudian di kenal dengan Uni Eropa pada
                                    tahun 1993. Negara ini juga menjadi anggota zona
                                    Schengen dan pengguna mata uang Euro sejak 2002.
                                    Sebagai negara penting, Jerman adalah anggota G8,
                                    G20, menduduki urutan keempat dalam Produk
                                    D o m e s t i k B r u t o d a n u r u t a n k e l i m a d a l a m
                                    Keseimbangan Kemampuan Berbelanja (2009), urutan
                                    kedua negara pengekspor dan dan menduduki urutan
                                    kedua di dunia dalam nilai bantuan pembangunan
                                    dalam anggaran tahunannya (2008).</p>
                            </div>
