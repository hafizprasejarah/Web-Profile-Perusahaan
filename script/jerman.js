...
let timeline3 = document.querySelector(".timeline-syarat");
const box3 = document.querySelectorAll(".num");
const card3 = document.querySelectorAll(".card-content");

if (timeline3 != null) {
    window.addEventListener("scroll", () => {
        let scrollY3 = window.scrollY;
        const ketinggianElemen3 = (box3[0].getBoundingClientRect().top + window.scrollY);
        const ketinggianbox = (box3[7].getBoundingClientRect().bottom + window.scrollY) - 200;
        ...
        box3.forEach(item => {
            ...
            else if (scrollPercentage3 >=  box3[7].getBoundingClientRect().top + tambahan) {
                box3[0].classList.add('active');
                box3[1].classList.add('active');
                box3[2].classList.add('active');
                box3[3].classList.add('active');
