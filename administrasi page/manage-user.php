...
$jumlah_post_query = "SELECT * FROM user WHERE  NOT id = $admin_id";
...
$query = "SELECT * FROM `user` WHERE NOT id = $admin_id LIMIT  $awaldata  ,$jumlah_post_per_page";
                                ...
                                <tbody>
                                    <?php while ($user = mysqli_fetch_assoc($users)) : ?>
                                        <tr>
                                            ...
                                            <td><?= $user['username'] ?></td>
                                            <td><?= $user['role'] ?></td>
                                            <td><a href="edit-user.php?id=<?= $user['id'] ?>" class="btn-manage edit">Edit</a></td>
                                            <td><a href="delete-user.php?id=<?= $user['id'] ?>" class="btn-manage delete">Delete</a></td>
                                        </tr>
                                    <?php endwhile ?>
                                </tbody>
                            </table>
                        <?php else : ?>
                            <div class="error_message"><?= "User not found" ?></div>
                        <?php endif ?>
