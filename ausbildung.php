                ...
                <div class="container-about">
                    ...
                    <div class="child-about">
                        ...
                        <div class="about-greeting">
                            <h3 class="about">about Ausbildung</h3>
                            <p class="greeting">Seputar Ausbildung!</p>
                        </div>

                        <div class="title-about">
                            <h1>apa itu ausbildung?</h1>
                        </div>

                        <div class="about-paragraf">
                            <p class="paragraf-1">
                                System Pendidikan Vokasi dan Profesi Terbaik Dunia
                            </p>

                            <p class="paragraf-2">
                                AUSBILDUNG adalah system pendidikan Vokasi Nasional
                                Jerman dengan porsi 30 % teori dan 70 % praktek industri.
                                Setiap peserta berhak mendapatkan gaji selama masa
                                pendidikan dengan besaran sesuai jurusan dan masa
                                pendidikan.
                            </p>
