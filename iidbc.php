        ...
        <div class="wrapper-section-1">
            <div class="sub-section-1">
                <div class="title-section-1">
                    ...
                    <p class="atas">Mengenal</p>
                    <h1>IDBC INTERNATIONAL</h1>
                    <p class="bawah">Adalah Lembaga Pendidikan non Formal yang totally mengadopsi system Pendidikan negara-negara maju dari hasil peneltian yang dilakukan oleh Foundernya Ust. Junaedy Alfan.
                        IDBC berdiri sejak 12 Januari tahun 2014, di Kampung IT Solo.
                        <br>
                        <br>
                        IDBC Internasional adalah divisi baru yang khusus untuk menjadi jembatan putra-putri bangsa Indonesia yang akan study di
                        luar Negeri, berdiri sejak 2021 dan focus sejak awaluntuk pengiriman kuliah ke Turki.
                        Sejak 2023 destinasi study luar negeri bertambah menjadi 3 Negara yaitu, Turki, Jepang dan Jerman.
                    </p>
